...
public class BannerInfoCanvasMediator extends BaseMediator {
    ...
    private function onInit(event:Event):void {
        ...
        arr1 = new Array("bannerName", "adFormat", "targetUrl", "ongoing", "startDate", "endDate", "filename");
        arr2 = new Array(uiComponent.bannerNameTI, uiComponent.adFormat, uiComponent.targetURLTI, uiComponent.ongoingChB, uiComponent.startDateDF, uiComponent.endDateDF, uiComponent.bannerFileTI);
        arr3 = new Array("text", "selectedItem", "text", "selected", "selectedDate", "selectedDate", "text");
        ...
        uiComponent.bannerNameTI.setFocus();
    }
    ...
    private function onBrowse(event:Event):void {
        uploadProxy.browseBanner(event, uiComponent.banner.uid);
    }
